...
\definecolor{qqqqff}{rgb}{0,0.39215686274509803,0}
\definecolor{qqffqq}{rgb}{0,0,1}
...
\draw [color=qqqqff](3.9007872968296593,8.815389811658244) node[anchor=north west] {$\bm{S}$};
\draw [color=qqffqq](95.46088215737039,101.20333363115502) node[anchor=north west] {$\bm{T}$};
\draw (87.18239256780974,95.5) node[anchor=north west] {$\bm{P_T}$};
\draw (5.722055006533001,19.742996069878295) node[anchor=north west] {$\bm{P_S}$};
...
\draw [color=ffqqqq](68.5,53.8) node[anchor=north west] {$\bm{G_{\mathcal B}=(V_{\mathcal B}, E_{\mathcal B})}$};
\draw [color=qqffqq](68,90.11015758114377) node[anchor=north west] {$\bm{E_T}$};
\draw [color=qqqqff](21.1200456431158,33.9819981639226) node[anchor=north west] {$\bm{E_S}$};
...
\draw [line width=1pt,dashed,color=qqffqq] (89.83150923646912,88.53724455912725)-- (60,70);
\draw [line width=1pt,dashed,color=qqffqq] (89.83150923646912,88.53724455912725)-- (95,60);
\draw [color=qqqqff](3.9007872968296593,8.898174707553851) node[anchor=north west] {$\bm{S}$};
\draw [color=qqffqq](95.46088215737039,101.12054873525942) node[anchor=north west] {$\bm{T}$};
\draw (87.18239256780974,95.5) node[anchor=north west] {$\bm{P_T}$};
\draw (20.457766475950947,15.024257003828726) node[anchor=north west] {$\bm{P_S}$};
\draw [line width=1pt,dashed,color=ffqqqq] (40,70)-- (60,50);
\draw [line width=1pt,dashed,color=ffqqqq] (60,50)-- (20,80);
\draw [line width=1pt,dashed,color=ffqqqq] (20,80)-- (90,10);
...
\draw [color=ffqqqq](68.5,53.8) node[anchor=north west] {$\bm{G_{\mathcal B}=(V_{\mathcal B}, E_{\mathcal B})}$};
\draw [color=qqffqq](68,90.19294247703937) node[anchor=north west] {$\bm{E_T}$};
\draw [color=qqqqff](28.736256065511594,33.56807368444457) node[anchor=north west] {$\bm{E_S}$};
\draw [line width=1pt,dashed,color=ffqqqq] (40,70)-- (95,60);
\draw [line width=1pt,dashed,color=ffqqqq] (40,70)-- (90,10);
