...
%		\end{mini*}}
		...
		The above information allows us to compare the difficulty of the problem, and, in addition, to test the matheuristic performance to obtain solutions for instances generated as stated in Subsection \ref{subsection:datageneration}. \CV{If we consider $Gap_{build}$, we can study how much the solver can improve the solution that it builds starting from the solution generated by the matheuristic.}
...
table {%
	...
	4.396 7.34476343039183
		...
		\input{tables/table_small_instances.tex}		
		\input{tables/table_big_instances.tex}
