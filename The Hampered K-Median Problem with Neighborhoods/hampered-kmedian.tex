	...
	%\textcolor{red}{
		...
		{\scriptsize
			\begin{mini*}[2]
				...
				\addConstraint{\eqref{eq:alphaC},\eqref{eq:betaC},\eqref{eq:gammaC},\eqref{eq:deltaC}, \eqref{eq:varepsilonC}}{}{}
				\addConstraint{\eqref{eq:dC}, \eqref{eq:nC}.}{}{}
		\end{mini*}}

		{\scriptsize
			\begin{mini*}[2]
				{}{\omega_E\sum_{(P,Q)\in E_X}\sum_{S\in\mathcal S}\sum_{T\in\mathcal T}\dvar{P}{Q}f(PQ|ST) + \frac{\omega_L}{2}\sum_{(P,Q)\in E_X}\sum_{S\in\mathcal S}\sum_{T\in\mathcal T}f(PQ|ST)}
