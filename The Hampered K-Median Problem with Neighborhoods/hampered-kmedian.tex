...
%		\end{mini*}}
		...
		We run the single-commodity model presented in Section \ref{section:formulations} in this scenario. The green neighbourhoods reported on the map of Fig. \ref{fig:casestudy} represent the sources in which the vans can be located, the blue, the targets where the drones serve the customers and the polygons, the buildings to be avoided. }
