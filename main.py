...
# segments = np.genfromtxt('./instancias/segmentos10-0.csv', delimiter = ',')
#
# barriers = []
# for lista in segments:
#     barriers.append([[lista[0], lista[1]], [lista[2], lista[3]]])
#
# bolas = np.genfromtxt('./instancias/bolas10-0.csv', delimiter = ',')
...
# resultados = h_kmedian_n(barriers, sources, targets, k, endurance, wE, wL, time_limit=3600, prepro=True, log=False, picture=True)
