                    ...
                    for l in lazy:
                        for init in inits:
                            ...
                            if not(a):
                                ...
                                resultados = h_kmedian_n(barriers1, sources=N, targets=N, k=k, wL=wL, lazy=l, A4=a, init=init,
                                                         time_limit=time_limit)

                                serie = pd.Series([instance] + resultados, index=dataframe.columns)

                                dataframe = dataframe.append(serie, ignore_index=True)
                                dataframe.to_csv('./resultados/resultados_buenos3.csv')
                                ...
                                resultados = h_kmedian_n(barriers2, sources=N, targets=N, k=k, wL=wL, lazy=l, A4=a, init=init,
                                                         time_limit=time_limit)
                                ...
                                resultados = h_kmedian_n(barriers3, sources=N, targets=N, k=k, wL=wL, lazy=l, A4=a, init=init,
                                                         time_limit=time_limit)
                                ...
                                resultados = h_kmedian_n(barriers, sources=N, targets=N, k=k, wL=wL, lazy=l, A4=a, init=init,
                                                         time_limit=time_limit)
