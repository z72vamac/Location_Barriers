...
dataframe = pd.DataFrame(columns=['Instance', 'n_N', 'n_B', 'k', 'wL', 'Gap', 'Runtime', 'NodeCount', 'ObjVal', 'Runtime_h', 'ObjVal_h'])
...
for instance in instances:
    for nn, k_list in zip(n_Ns, ks):
        for k in k_list:
            ...
            resultados = h_kmedian_n(barriers, sources=N, targets=N, k = k, wL = wL, time_limit=time_limit)
