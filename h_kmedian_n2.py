...
def h_kmedian_n(barriers, sources, targets, k, prepro=True, log=False, dominant=False, picture=False, time_limit=7200, init=False):
    ...
    if not(dominant):
        ...
        #         model.addConstr(2*gamma[a, b, c, d, e, f, g, h] + 1 - alpha[a, b, e, f, g, h] - alpha[c, d, e, f, g, h] + 2*gamma[e, f, g, h, a, b, c, d] + 1 - alpha[e, f, a, b, c, d] - alpha[g, h, a, b, c, d] <= 2*delta[a, b, c, d, e, f, g, h])
        #         model.addConstr(2*gamma[a, b, c, d, e, f, g, h] + 1 - alpha[a, b, e, f, g, h] - alpha[c, d, e, f, g, h] + 2*gamma[e, f, g, h, a, b, c, d] + 1 - alpha[e, f, a, b, c, d] - alpha[g, h, a, b, c, d] >= delta[a, b, c, d, e, f, g, h])
        #
        # for a, b, c, d in epsilon_index:
        ...
        objective += gp.quicksum(p[index] for index in edges_source + edges_target) #+ objective
        ...
        # p_indices = [(index, p[index].X) for index in p.keys() if p[index].X > 0.5]
