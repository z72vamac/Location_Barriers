...
def h_kmedian_n(barriers, sources, targets, k, single = False, wL=50, lazy=True, A4=True, prepro=True, log=False, picture=False, time_limit=7200, init=False):
    ...
    def include_edges_source():
        
        start_edges_source = time.time()
        ...
        time_elapsed_edges_source = time.time() - start_edges_source

        print('Finish including edges_source')
        print(f'Time spent to include edges_source: {time_elapsed_edges_source}')
    
    edges_barrier = []

    def include_edges_barrier():
        
        start_edges_barrier = time.time()
        ...
        time_elapsed_edges_barrier = time.time() - start_edges_barrier

        print('Finish including edges_barrier')
        print(f'Time spent to include edges_barrier: {time_elapsed_edges_barrier}')
    ...
    def include_edges_target():
        start_edges_target = time.time()
        ...
        time_elapsed_edges_target = time.time() - start_edges_target

        print('Finish including edges_target')
        print(f'Time spent to include edges_target: {time_elapsed_edges_target}')
    ...
    def include_edges_source_target():
        start_edges_source_target = time.time()
        ...
        time_elapsed_edges_source_target = time.time() - start_edges_source_target

        print('Finish including edges_source_target')
        print(f'Time spent to include edges_source_target: {time_elapsed_edges_source_target}')
    ...
    with ThreadPoolExecutor(max_workers=4) as executor:
        ...
        executor.submit(include_edges_source)
        executor.submit(include_edges_barrier)
        executor.submit(include_edges_target)
        executor.submit(include_edges_source_target)
