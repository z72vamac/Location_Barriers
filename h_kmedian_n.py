                    ...
                    if (a, b, c, d) in edges_source:
                        ...
                        for e in range(1000, 1000 + len(barriers)):
                            ...
                            if det1*det2 < 0 and det3*det4 < 0:
                                ...
                                L2= -5*abs(af.determinant(barriers[c - 1000][d], barriers[e - 1000][0], barriers[e - 1000][1]))
                                U2 = 5*abs(L2)
                                model.cbLazy(
                        ...
                        for e in range(1000, 1000 + len(barriers)):
                            ...
                            if det1 * det2 < 0 and det3 * det4 < 0:
                                ...
                                L2= -5*abs(af.determinant(barriers[a - 1000][d], barriers[e - 1000][0], barriers[e - 1000][1]))
                                U2 = 5*abs(L2)
                                model.cbLazy(
